...
class Summary(object):
    ...
    def __str__(self):
        return u"Title: {0} <br/>Url: <a style='color:red;' href={1}>{1}</a><br/><br/>Summed Up:<br/>{2}<p style='float:right;color:rgb(86, 197, 51);font-size:11px;'>Report: <a style='color:rgb(86, 197, 51);' href='mailto:report@sumitraj.in'>report@sumitraj.in</a></p>".format(self.title, self.url, '\n'.join(self.summaries))
